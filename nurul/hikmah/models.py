...
class Kategori(models.Model):
    ...
    banner_satu = ResizedImageField(size=[575, 200], quality=80, crop=['middle', 'center'] , upload_to='gambar/banner', blank=False, null=True, verbose_name="Gambar Banner Satu (575 x 200 pixel)")
    banner_dua = ResizedImageField(size=[575, 200], quality=80, crop=['middle', 'center'] , upload_to='gambar/banner', blank=False, null=True, verbose_name="Gambar Banner Satu (575 x 200 pixel)")
...
class Produk(models.Model):
    ...
    gambar_satu = models.ImageField(upload_to='gambar/banner', blank=True, null=True, verbose_name="Gambar Satu (270 x 250 pixel)")
    gambar_dua = models.ImageField(upload_to='gambar/banner', blank=True, null=True, verbose_name="Gambar Dua (270 x 250 pixel)")
    gambar_tiga = models.ImageField(upload_to='gambar/banner', blank=True, null=True, verbose_name="Gambar Tiga (270 x 250 pixel)")
    gambar_empat = models.ImageField(upload_to='gambar/banner', blank=True, null=True, verbose_name="Gambar Empat (270 x 250 pixel)")
    gambar_lima= models.ImageField(upload_to='gambar/banner', blank=True, null=True, verbose_name="Gambar Lima (270 x 250 pixel)")
    ...
    aktif = models.BooleanField(default=False, blank=True, null=True)
